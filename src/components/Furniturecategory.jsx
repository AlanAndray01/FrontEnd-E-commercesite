...
import promoImage1 from '../assets/Image/backgrounds/Group 969.png';

const promoImage = promoImage1;
        ...
        <div className="md:grid md:grid-cols-[260px_1fr]">
          ...
          >
            ...
            <div className="absolute top-4 left-4 p-2 rounded-md max-w-[180px]">
              <h2 className="text-xl font-bold text-gray-900 mb-5">Home and <br></br>outdoor</h2>
              <a
                href="/category/home-outdoor"
