...
// ];
  ...
  return (
    ...
    <div className='border-b border-gray-200 bg-white'>
            <div className='max-w-7xl mx-auto flex items-center justify-between py-2 h-auto lg:h-14 px-4 sm:px-6'>

                {/* Main Link Container: Uses flex-nowrap to prevent wrapping and keeps items horizontal */}
                <div className='flex flex-nowrap items-center text-sm font-medium text-gray-700 w-full'>

                    {/* 1. All Category Link (Fixed Position - Not Scrollable) */}
                    <a href="#" className='flex items-center space-x-2 p-2 rounded-lg hover:bg-blue-400 hover:text-white transition whitespace-nowrap flex-shrink-0'>
                        <Menu size={20} />
                        <span>All category</span>
                    </a>

                    {/* 2. Scrollable Links Container */}
                    {/* Key classes: overflow-x-auto, scrollbar-hide (if you have the utility) */}
                    <div className='flex items-center space-x-4 ml-4 lg:space-x-8 overflow-x-auto whitespace-nowrap scrollbar-hide'>

                        {/* Note: I removed the "hidden lg:flex" from the container to make it visible on mobile.
                           I also adjusted the margins (p-2 -ml-2) to be just p-2 for cleaner mobile layout. */}

                        <a href="#" className='p-2 rounded-lg hover:bg-blue-400 hover:text-white transition'>Hot offers</a>
                        <a href="#" className='p-2 rounded-lg hover:bg-blue-400 hover:text-white transition'>Gift boxes</a>
                        <a href="#" className='p-2 rounded-lg hover:bg-blue-400 hover:text-white transition'>Projects</a>
                        
                        {/* Adding more links to demonstrate scrolling */}
                        <a href="#" className='p-2 rounded-lg hover:bg-blue-400 hover:text-white transition'>Trending Items</a>
                        <a href="#" className='p-2 rounded-lg hover:bg-blue-400 hover:text-white transition'>New Arrivals</a>
                        <a href="#" className='p-2 rounded-lg hover:bg-blue-400 hover:text-white transition'>Clearance</a>
                        
                        {/* Menu Item Dropdown */}
                        <div className='flex items-center p-2 rounded-lg group cursor-pointer hover:bg-blue-400 hover:text-white transition'>
                            <span>Menu item</span>
                        </div>
